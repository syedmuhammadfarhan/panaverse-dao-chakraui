...
import { CommonQuarters, AiQuarters } from "../components/Data/page-data";
      ...
      <VStack>
        ...
        >
          ...
          <Center
            ...
            textAlign={"center"}
          >
            For Detailed Syllabus<br/>Click Here
          </Center>
        </VStack>
      </VStack>
      <VStack>
        <Box w={"100%"} maxW={"80%"} bg="gray.100" pb={"4rem"}>
          <Box mb={"2rem"}>
